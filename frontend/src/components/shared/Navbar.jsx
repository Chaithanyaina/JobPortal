                ...
                <div className='flex items-center gap-12'>
                    <ul className='flex font-medium items-center gap-6 text-lg'>
                        {user && user.role === 'recruiter' ? (
                            <>
                                <li><Link to="/admin/companies" className='hover:text-[#F8B400] transition'>Companies</Link></li>
                                <li><Link to="/admin/jobs" className='hover:text-[#F8B400] transition'>Jobs</Link></li>
                            </>
                        ) : (
                            <>
                                <li><Link to="/" className='hover:text-[#F8B400] transition'>Home</Link></li>
                                <li><Link to="/jobs" className='hover:text-[#F8B400] transition'>Jobs</Link></li>
                                <li><Link to="/browse" className='hover:text-[#F8B400] transition'>Browse</Link></li>
                            </>
                        )}
                    </ul>
                    ...
                    {!user ? (
                        <div className='flex items-center gap-4'>
                            ...
                            <Link to="/signup">
                                <Button 
                                    className="bg-[#F8B400] hover:bg-[#d99a00] text-white transition rounded-full px-6 py-2"
                                >
                                    Signup
                                </Button>
                            </Link>
                                    ...
                                    <div className='flex flex-col mt-3 text-gray-700'>
                                        {user && user.role === 'student' && (
                                            <div className='flex items-center gap-2 cursor-pointer text-[#2D1E6B] hover:text-[#F8B400] transition'>
                                                <User2 size={18} />
                                                <Link to="/profile">
                                                    <Button variant="link" className="text-inherit">View Profile</Button>
                                                </Link>
                                            </div>
                                        )}
                                        ...
                                        <div className='flex items-center gap-2 cursor-pointer text-red-500 hover:text-red-700 transition'>
                                            <LogOut size={18} />
                                            <Button onClick={logoutHandler} variant="link" className="text-inherit">Logout</Button>
                                        </div>
                                    </div>
                                </div>
                            </PopoverContent>
